                ...
                <tr>
                  <td style="padding: 24px !important;">
                    ...
                    <table role="presentation" style="width: 100% !important; margin-bottom: 24px !important;">
                      <tr><td style="padding: 8px 0 !important;"><p style="margin: 0 !important; color: #4a5568 !important; font-size: 14px !important; line-height: 1.6 !important; font-family: 'Archivo', -apple-system, sans-serif !important;"><span style="color: #BC6170 !important; font-weight: 700 !important;">✓</span> <strong>0,5 point</strong> par euro dépensé</p></td></tr>
                      <tr><td style="padding: 8px 0 !important;"><p style="margin: 0 !important; color: #4a5568 !important; font-size: 14px !important; line-height: 1.6 !important; font-family: 'Archivo', -apple-system, sans-serif !important;"><span style="color: #BC6170 !important; font-weight: 700 !important;">✓</span> Convertis tes points en <strong>codes promo</strong></p></td></tr>
                      <tr><td style="padding: 8px 0 !important;"><p style="margin: 0 !important; color: #4a5568 !important; font-size: 14px !important; line-height: 1.6 !important; font-family: 'Archivo', -apple-system, sans-serif !important;"><span style="color: #BC6170 !important; font-weight: 700 !important;">✓</span> Débloque des <strong>cartes cadeaux exclusives</strong></p></td></tr>
                      <tr><td style="padding: 8px 0 !important;"><p style="margin: 0 !important; color: #4a5568 !important; font-size: 14px !important; line-height: 1.6 !important; font-family: 'Archivo', -apple-system, sans-serif !important;"><span style="color: #BC6170 !important; font-weight: 700 !important;">✓</span> 5 paliers : Bronze, Argent, Or, Diamant, Maître</p></td></tr>
                    </table>
...
export default async function handler(req, res) {
  ...
  if (action === 'signup') {
    try {
      ...
      // Créer code promo et envoyer email de bienvenue
      try {
  ...
  if (action === 'password-reset-request') {
    ...
    try {
      ...
      try {
        const emailHtml = getPasswordResetEmailTemplate(user.first_name, resetUrl)
